...
// export default class MainGridPartial extends React.Component {
//   constructor(props){
//     super(props);
...
//     this.handleRestart = this.handleRestart.bind(this)
//     this.handleTest = this.handleTest.bind(this)
//     this.noteNames = ["A1", "F#", "E", "C#", "B", "A2"].reverse();
//     // let noteNames = ["A1", "B1", "C#2", "E2", "F#2", "A2"].reverse();
    
//     // this.noteNames = noteNames.map(note => props.instrument[0] + note);
//   }
